          ...
          <b-card-code>
            ...
            >
              <feather-icon
                ...
                size="34"
                icon="ArrowLeftIcon"
              /> <span style="font-size:20px; color: #ffffff;">กราฟแสดงการซ่อมอุปกรณ์ (รายปี)</span>
            </b-link>
            <b-row>
              <b-col
                md="4"
                class="d-flex text-sm-left mt-1"
              >
                <label style="padding-right:14px; font-size: 15px">จาก</label>
                <b-form-group style="padding-right:16px">
                  <!-- <flat-pickr
                    v-model="date.yearFrom"
                    class="form-control"
                    @input="getHistory"
                  /> -->
                  <b-form-select
                ...
                <b-form-group style="padding-right:150px">
                  <!-- <flat-pickr
                    v-model="date.yearTo"
                    class="form-control"
                    @input="getHistory"
...
import ExportRepairYear from './ExportRepairYear.vue'
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        {
          key: 'date_time', label: 'ปี', sortable: true, class: 'text-center',
        },
        {
          key: 'event', label: 'เหตุการณ์', sortable: true, class: 'text-center',
        },
        {
          key: 'count_event', label: 'จำนวน', sortable: true, class: 'text-center',
        },
      ],
      // --------history--------
      perPage: 25,
  ...
  methods: {
    setToday() {
      ...
      this.date.yearFrom = `${year}`
      this.date.yearTo = `${year}`
    },
    getHistory() {
      axios
        .post('/reportProblem1Years-Electic', this.date)
        .then(response => {
