            ...
            <div>
              ...
              >
                <feather-icon
                  ...
                  size="34"
                  icon="ArrowLeftIcon"
                /> <span style="font-size:20px; color: #ffffff;">กราฟแสดงการทำงานของตู้ควบคุม (Amp รายปี)</span>
              </b-link>
              <app-echart-line
                :option-data="option"
                style="width: 100%"
...
import ExportSemControlYear from './ExportSemControlYear.vue'
