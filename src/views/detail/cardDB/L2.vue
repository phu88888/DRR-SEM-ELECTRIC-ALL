<template>
  <div>
    <b-row>
      ...
      >
        <b-card
          class="l2-gradient-border-card d-flex justify-content-center align-items-center"
          style="background-color:rgba(0, 0, 0, 0.6); color:#ffffff; text-align: center;"
        >
          <b-row class="w-100">
            <b-col
              lg="12"
            ...
            >
              <b-row>
                <b-col
                  ...
                  xs="6"
                >
                  <span class="info-label">Volt : <span style="color: #fff">{{ voltP2 }}</span></span>
                </b-col>
                <b-col
                  lg="6"
                  md="6"
                  ...
                  xs="6"
                >
                  <span class="info-label">kWh : <span style="color: #fff">{{ kwhP2 }}</span></span>
                </b-col>
              </b-row>
            </b-col>
            ...
            >
              <b-row>
                <b-col
                  ...
                  xs="6"
                >
                  <span class="info-label shadow1">Amp : <span style="color: #fff">{{ ampP2 }}</span></span>
                </b-col>
                <b-col
                  lg="6"
                  md="6"
                  ...
                  xs="6"
                >
                  <span class="info-label">Hz : <span style="color: #fff">{{ hzP2 }}</span></span>
                </b-col>
              </b-row>
            </b-col>
            ...
            >
              <b-row>
                <b-col
                  ...
                  xs="6"
                >
                  <span class="info-label">Watt : <span style="color: #fff">{{ wattP2 }}</span></span>
                </b-col>
                <b-col
                  lg="6"
                  md="6"
                  ...
                  xs="6"
                >
                  <span class="info-label">Pf : <span style="color: #fff">{{ pfP2 }}</span></span>
                </b-col>
              </b-row>
            </b-col>
          </b-row>
    ...
    getMarkerSem() {
      axios
        ...
        .then(response => {
          ...
          this.voltP2 = this.items[0].volt_phase2
          this.ampP2 = this.items[0].amp_phase2
          this.wattP2 = this.items[0].watt_phase2
          this.pfP2 = this.items[0].pf_phase2
          this.kwhP2 = this.items[0].kwh_phase2
          this.hzP2 = this.items[0].hz_phase2
        })
        .catch(error => {
          console.log(error)
        })
...
.l2-gradient-border-card::before {
  content: "";
  position: absolute;
  top: 0;
  left: 0;
