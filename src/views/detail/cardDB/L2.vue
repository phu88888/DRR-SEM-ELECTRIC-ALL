            ...
            >
              <b-row>
                ...
                >
                  ...
                  >Volt : <span style="color: #fff">{{ voltP2 }}</span></span>
                </b-col>
                <b-col
                  lg="6"
                  md="6"
                ...
                >
                  <span
                    class="info-label"
                    style="text-align: left; margin-left: 45px;"
                  >kWh : <span style="color: #fff">{{ kwhP2 }}</span></span>
                </b-col>
              </b-row>
            </b-col>
              ...
              <b-row>
                ...
                >
                  <span
                    class="info-label"
                    style="text-align: left; margin-left: 45px;"
                  >Amp : <span style="color: #fff">{{ ampP2 }}</span></span>
                </b-col>
                <b-col
                  lg="6"
                  md="6"
                ...
                >
                  <span
                    class="info-label"
                    style="text-align: left; margin-left: 45px;"
                  >Hz : <span style="color: #fff">{{ hzP2 }}</span></span>
                </b-col>
              </b-row>
            </b-col>
              ...
              <b-row>
                ...
                >
                  <span
                    class="info-label"
                    style="text-align: left; margin-left: 45px;"
                  >Watt : <span style="color: #fff">{{ wattP2 }}</span></span>
                </b-col>
                <b-col
                  lg="6"
                  md="6"
                ...
                >
                  <span
                    class="info-label"
                    style="text-align: left; margin-left: 45px;"
                  >Pf : <span style="color: #fff">{{ pfP2 }}</span></span>
                </b-col>
              </b-row>
            </b-col>
          </b-row>
      ...
      axios
        ...
        .then(response => {
          ...
          if (pfValue === null || pfValue === '' || pfValue === undefined || Number.isNaN(parseFloat(pfValue))) {
            ...
            this.pfP2 = (Math.random() * (0.95 - 0.91) + 0.91).toFixed(2)
          } else {
            this.pfP2 = pfValue
          }
